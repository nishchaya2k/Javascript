/*
Problem Statement: Given the root of a binary tree, return the Pre Order traversal of its nodes' values.
*/
...
//Approach 1, do -> NLR, TC: O(n), SC: O(h)
function preOrder_1(input){
...
console.log("Pre Order",preOrder_1(input))