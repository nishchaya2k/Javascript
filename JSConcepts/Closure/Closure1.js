...
function x3() {
    ...
    return y3;      //bcoz of first class function we can return
}
...
function x4() {
    ...
    b = 110;
    return y4;
    c = 120;  //memory leakage
    a = 200;  //will not execute this line, already returned x4
}

var z4 = x4();

//all the variable which which z4 need to memorze are store in heap memory when x4 popout
z4();  //100    
...
2.  What is Lexical Scope ->  lexical scope is the concept of determining the scope of a variable based on its declaration
