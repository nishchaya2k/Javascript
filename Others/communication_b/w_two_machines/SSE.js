...
1. In Server-Sent Events (SSE), the client establishes a persistent unidirectional connection with the server using a standard HTTP request.

2. The server sends events or updates to the client as they occur.
